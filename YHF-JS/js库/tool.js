...
** W3C ：obj.addEventListener(type,fn,false);
** IE  ：obj.attachEvent('on' + type, function(){fn.call(obj);});
***/
...
//执行事件处理函数
addEvent.execuse = function (ev) {
	var oEvent = ev || addEvent.fixEvent(window.event);
